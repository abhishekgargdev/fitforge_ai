            ...
            return (
              ...
              >
                <div className="flex items-center justify-between text-xs mb-1">
                  <span className="font-bold text-white">{dayItem.day}</span>
                  {idx === 0 && (
              ...
              <div>
                <div className="flex items-center gap-2">
                  <h4 className="text-base font-bold text-white">
                    {currentSplit.days[selectedDayIndex].day} — {currentSplit.days[selectedDayIndex].workout?.name}
                  </h4>
                ...
                <p className="text-xs text-[#9AA3A0] mt-0.5">
                  {currentSplit.days[selectedDayIndex].workout?.targetMuscles?.join(', ') || 'Targeted Muscle Groups'}
                </p>
              </div>
