      ...
      <footer className="bg-[#0B0D0F] border-t border-[#252B30] py-12 text-xs text-[#9AA3A0]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-6">
            <button onClick={onExploreDemo} className="hover:text-[#B8F34A] transition-colors">
              Live Demo
            </button>
            <button onClick={onGetStarted} className="hover:text-[#B8F34A] transition-colors">
              Onboarding
            </button>
            <button onClick={onLogin} className="hover:text-[#B8F34A] transition-colors">
              Sign In
            </button>
            <a href="#features" className="hover:text-white transition-colors">
              Science
