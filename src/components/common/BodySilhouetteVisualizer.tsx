...
export const BodySilhouetteVisualizer: React.FC<BodySilhouetteVisualizerProps> = ({
  ...
  const regionData = {
    ...
    arms: {
      ...
      notes: 'Biceps, triceps, deltoids, and forearms. Lean mass retention is excellent.',
    },
    legs: {
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
        {/* Interactive Silhouette Graphic */}
        ...
        {/* Region Breakdown & Detailed Cards */}
        <div className="lg:col-span-7 flex flex-col gap-4">
          <div className="bg-[#181D22] border border-[#252B30] rounded-xl p-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-xs text-[#9AA3A0]">Measured Distribution</span>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 mb-3">
              ...
              <div className="bg-[#12161A] p-3 rounded-lg border border-[#252B30]/80">
                <div className="flex items-center justify-between text-xs text-[#9AA3A0] mb-1">
                  ...
                  <span className="text-[10px] text-[#45D483] font-semibold">↓ 1.4%</span>
                </div>
            ...
            <p className="text-xs text-[#9AA3A0] leading-relaxed bg-[#0B0D0F]/40 p-2.5 rounded-lg border border-[#252B30]/40">
              <strong className="text-white font-semibold">Diagnostic Insight: </strong>
              {current.notes}
            </p>
          </div>

          {/* Quick Whole-Body Overview Matrix */}
          <div className="grid grid-cols-3 gap-2">
            <div className="bg-[#181D22]/80 border border-[#252B30] p-2.5 rounded-xl text-center">
              ...
              <span className="text-[10px] text-[#45D483] block font-medium">Rating: Healthy</span>
            </div>
            <div className="bg-[#181D22]/80 border border-[#252B30] p-2.5 rounded-xl text-center">
              ...
              <span className="text-[10px] text-[#5DA9FF] block font-medium">3 yrs younger</span>
            </div>
            <div className="bg-[#181D22]/80 border border-[#252B30] p-2.5 rounded-xl text-center">
